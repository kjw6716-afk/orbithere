...
`about.html#contact`의 제작자 문의 버튼은 받는 사람과 제목을 입력한 Gmail 작성 화면을 새 탭에서 엽니다. 이메일 주소 링크는 다른 메일 앱을 지원합니다. 방문자가 내용을 작성하고 직접 전송하며, 사이트에서 메일을 자동 발송하거나 Gmail 계정 권한을 요청하지 않습니다.
